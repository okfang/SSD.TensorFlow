...
class CocoDetectionEvaluator(object_detection_evaluation.DetectionEvaluator):
    ...
    def add_single_ground_truth_image_info(self,
        ...
        self._groundtruth_list.extend(
            coco_tools.ExportSingleImageGroundtruthToCoco(
                ...
                groundtruth_boxes=groundtruth_dict["groundtruth_boxes"],
                groundtruth_classes=groundtruth_dict["groundtruth_classes"],
                groundtruth_is_crowd=groundtruth_is_crowd))
        self._annotation_id += groundtruth_dict["groundtruth_boxes"].shape[0]
    ...
    def get_estimator_eval_metric_ops(self, eval_dict):
        ...
        image_id = eval_dict["key"]
        groundtruth_boxes = eval_dict["groundtruth_boxes"]
        groundtruth_classes = eval_dict["groundtruth_classes"]
        groundtruth_is_crowd = eval_dict.get(
            "groundtruth_is_crowd", None)
        detection_boxes = eval_dict["detection_boxes"]
        detection_scores = eval_dict["detection_scores"]
        detection_classes = eval_dict["detection_classes"]
