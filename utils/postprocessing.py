...
def per_image_post_process(cls_pred, bboxes_pred,mode,select_threshold=None, min_size=None, keep_topk=None, nms_topk=None, nms_threshold=None,is_tack_A=False,is_task_B=False,num_classes=21):
    """
